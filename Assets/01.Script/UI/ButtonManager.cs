...
public class ButtonManager : MonoBehaviour
{
    ...
    public void OnClick()
    {
        ...
        else if (buttonName == "Quiting")
        {
            gameManager.QuitingUI();
            //gameObject.SetActive(false);
        }
        else if (buttonName == "GameQuit")
        {
            Application.Quit();
        }

        else if (buttonName == "Item1")
        {
            gameManager.Item1Use();
        }
        else if (buttonName == "Item2")
        {
            gameManager.Item2Use();
        }
        else if (buttonName == "Item3")
        {
            gameManager.Item3Use();
        }
